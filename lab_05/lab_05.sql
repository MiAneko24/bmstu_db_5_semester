...
-- Сделать врача-специалиста. Триггер, который будет отправлять всех животных с определенным заболеванием к одному выбранному ученому. И распечатайте животных этого ученого в JSON 
